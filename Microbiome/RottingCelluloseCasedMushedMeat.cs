...
{
	public class RottingCelluloseCasedMushedMeat : ModItem
	{
		public override void SetStaticDefaults() 
		{
			Tooltip.SetDefault("Also known as a 'hot dog'\nIt entices you greatly, despite it is rotting and morally disgusting\nSummons Colossal Cell in the Microbiome");
