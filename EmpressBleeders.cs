...
namespace Zylon.Projectiles
{
	public class EmpressBleeders : ModProjectile
	{
		...
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
		{
			...
			Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, projectile.velocity.X * -1, projectile.velocity.Y * -1, mod.ProjectileType("EmpressBleeders"), projectile.damage - 10, 3, Main.myPlayer);
		}
