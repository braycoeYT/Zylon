...
namespace Zylon
{
	public class ZylonWorld : ModWorld
	{
		...
		private void Microbiome(GenerationProgress progress)
		{
			...
			int microSpawnX = Main.maxTilesX - Main.rand.Next(600, Main.maxTilesX - 600);
			int microSpawnY = (int)Main.worldSurface + Main.rand.Next(-100, -50);
			for (int k = 0; k < 0; k++)
			{
			...
			for (int i = 0; i < Main.rand.Next(270, 301); i++)
			{
				WorldGen.TileRunner(microSpawnX + Main.rand.Next(-190, 190), Main.rand.Next((int)Main.worldSurface - 300, (int)Main.rockLayer + 150), (double)WorldGen.genRand.Next(30, 91), WorldGen.genRand.Next(40, 101), TileType<Tiles.Microbiome.CellMembrane>(), false, 0f, 0f, false, true);
			}
			for (int i = 0; i < Main.rand.Next(90, 121); i++)
			{
				WorldGen.TileRunner(microSpawnX + Main.rand.Next(-190, 190), Main.rand.Next((int)Main.worldSurface - 300, (int)Main.rockLayer + 150), (double)WorldGen.genRand.Next(20, 31), WorldGen.genRand.Next(30, 41), TileType<Tiles.Microbiome.DiseasedStone>(), false, 0f, 0f, false, true);
			}
			for (int i = 0; i < Main.rand.Next(180, 241); i++)
			{
				WorldGen.TileRunner(microSpawnX + Main.rand.Next(-190, 190), Main.rand.Next((int)Main.worldSurface - 300, (int)Main.rockLayer + 150), (double)WorldGen.genRand.Next(10, 21), WorldGen.genRand.Next(20, 31), TileType<Tiles.Microbiome.DiseasedStone>(), false, 0f, 0f, false, true);
			}
			for (int i = 0; i < Main.rand.Next(315, 441); i++)
			{
				WorldGen.TileRunner(microSpawnX + Main.rand.Next(-190, 190), Main.rand.Next((int)Main.worldSurface - 300, (int)Main.rockLayer + 150), (double)WorldGen.genRand.Next(5, 11), WorldGen.genRand.Next(10, 21), TileType<Tiles.Microbiome.DiseasedStone>(), false, 0f, 0f, false, true);
			}
			for (int i = 0; i < Main.rand.Next(600, 651); i++)
			{
				WorldGen.TileRunner(microSpawnX + Main.rand.Next(-190, 190), Main.rand.Next((int)Main.worldSurface - 300, (int)Main.rockLayer + 150), (double)WorldGen.genRand.Next(1, 4), WorldGen.genRand.Next(1, 4), TileType<Tiles.Microbiome.DiseasedStone>(), false, 0f, 0f, false, true);
			}
			...
			for (int i = 0; i < Main.rand.Next(16, 37); i++)
			{
				WorldGen.TileRunner(microSpawnX + Main.rand.Next(-190, 190), Main.rand.Next((int)Main.worldSurface - 300, (int)Main.rockLayer + 10), (double)WorldGen.genRand.Next(1, 4), WorldGen.genRand.Next(1, 4), TileType<Tiles.Microbiome.TwistedMembraneOre>(), false, 0f, 0f, false, true);
			}
