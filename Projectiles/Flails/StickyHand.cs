...
namespace Zylon.Projectiles.Flails
{
	...
	{
		private const string ChainTexturePath = "Zylon/Projectiles/Flails/StickyHandChain"; // The folder path to the flail chain sprite
		private const string ChainTextureExtraPath = "Zylon/Projectiles/Flails/StickyHandChainExtra";  // This texture and related code is optional and used for a unique effect
		...
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit) {
			if (!hasStruck && Projectile.ai[0] != 0) {
				targetN = target;
				hasStruck = true;
				Projectile.ai[0] = -1;
			}
		...
		public override bool PreAI() {
			...
			return true;//!(hasStruck && stickTime < 90);
		}
