...
namespace Zylon.Projectiles.Flails
{
	public class LihzahrdBoulderonaChain : ModProjectile
	{
		...
		public override void AI() {
			...
			float retractAcceleration = 4.5f; // How quickly the projectile will accelerate back towards the player while retracting
		...
		public override bool OnTileCollide(Vector2 oldVelocity) {
			if (!bool1) {
				ProjectileHelpers.NewNetProjectile(Projectile.GetSource_FromThis(), Projectile.Center - new Vector2(0, 20), new Vector2(0, 0), ProjectileID.DD2ExplosiveTrapT3Explosion, Projectile.damage, Projectile.knockBack*1.25f, Projectile.owner);
				bool1 = true;
			}
