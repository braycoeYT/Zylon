...
namespace Zylon.Projectiles.Flails
{
	...
	public class TheArchangel : ModProjectile
	{
		private const string ChainTexturePath = "Zylon/Projectiles/Flails/TheArchangelChain"; // The folder path to the flail chain sprite
		private const string ChainTextureExtraPath = "Zylon/Projectiles/Flails/TheArchangelChain";  // This texture and related code is optional and used for a unique effect
		...
		public override void AI() {
			...
			float retractAcceleration = 4.2f; // How quickly the projectile will accelerate back towards the player while retracting
			...
			int defaultHitCooldown = 12; // How often your flail hits when resting on the ground, or retracting
			int spinHitCooldown = 24; // How often your flail hits when spinning
