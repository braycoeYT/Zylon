...
namespace Zylon.Projectiles.Flails
{
	...
	public class DiskiteonaLeash : ModProjectile
	{
		private const string ChainTexturePath = "Zylon/Projectiles/Flails/DiskiteonaLeashChain"; // The folder path to the flail chain sprite
		private const string ChainTextureExtraPath = "Zylon/Projectiles/Flails/DiskiteonaLeashChainExtra";  // This texture and related code is optional and used for a unique effect
		...
		public override void SetDefaults() {
			...
			Projectile.height = 64; // The height of your Projectile
			Projectile.friendly = true; // Deals damage to enemies
			Projectile.penetrate = -1; // Infinite pierce
			Projectile.DamageType = DamageClass.Melee; // Deals melee damage
			Projectile.usesLocalNPCImmunity = true; // Used for hit cooldown changes in the ai hook
			Projectile.localNPCHitCooldown = 25; // This facilitates custom hit cooldown logic
		...
		public override void AI() {
			...
			int launchTimeLimit = 13;  // How much time the Projectile can go before retracting (speed and shootTimer will set the flail's range)
			float launchSpeed = 11f; // How fast the Projectile can move
			float maxLaunchLength = 775f; // How far the Projectile's chain can stretch before being forced to retract when in launched state
			float retractAcceleration = 2.3f; // How quickly the Projectile will accelerate back towards the player while retracting
			float maxRetractSpeed = 10f; // The max speed the Projectile will have while retracting
			float forcedRetractAcceleration = 5.5f; // How quickly the Projectile will accelerate back towards the player while being forced to retract
			float maxForcedRetractSpeed = 12f; // The max speed the Projectile will have while being forced to retract
			float unusedRetractAcceleration = 0.9f;
