...
namespace Zylon.Projectiles.Flails
{
	...
	public class BoulderonaChain : ModProjectile
	{
		...
		public override bool OnTileCollide(Vector2 oldVelocity) {
			if (!bool1) {
				ProjectileHelpers.NewNetProjectile(Projectile.GetSource_FromThis(), Projectile.Center - new Vector2(0, 20), new Vector2(0, 0), ProjectileID.DD2ExplosiveTrapT2Explosion, Projectile.damage, 12f, Projectile.owner);
				bool1 = true;
			}
