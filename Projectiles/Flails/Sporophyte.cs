...
namespace Zylon.Projectiles.Flails
{
	...
	{
		private const string ChainTexturePath = "Zylon/Projectiles/Flails/SporophyteChain"; // The folder path to the flail chain sprite
		private const string ChainTextureExtraPath = "Zylon/Projectiles/Flails/SporophyteChainExtra";  // This texture and related code is optional and used for a unique effect
		...
		public override void AI() {
			...
			float maxLaunchLength = 825f; // How far the Projectile's chain can stretch before being forced to retract when in launched state
