...
namespace Zylon.Projectiles.Flails
{
	...
	{
		private const string ChainTexturePath = "Zylon/Projectiles/Flails/TheMeteoriteChain";
		...
		public override void AI() {
			...
			float launchSpeed = 22f; // How fast the projectile can move
			float maxLaunchLength = 1700f; // How far the projectile's chain can stretch before being forced to retract when in launched state
			float retractAcceleration = 3.1f; // How quickly the projectile will accelerate back towards the player while retracting
			float maxRetractSpeed = 10.5f; // The max speed the projectile will have while retracting
			float forcedRetractAcceleration = 7f; // How quickly the projectile will accelerate back towards the player while being forced to retract
