...
namespace Zylon.Projectiles.Flails
{
	...
	{
		private const string ChainTexturePath = "Zylon/Projectiles/Flails/ShadowMoonChain"; // The folder path to the flail chain sprite
		private const string ChainTextureExtraPath = "Zylon/Projectiles/Flails/ShadowMoonChainExtra";  // This texture and related code is optional and used for a unique effect
		...
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Shadow Moon");
		...
		public override void AI() {
			...
			float launchSpeed = 12f; // How fast the Projectile can move
			float maxLaunchLength = 875f; // How far the Projectile's chain can stretch before being forced to retract when in launched state
			...
			float forcedRetractAcceleration = 6.5f; // How quickly the Projectile will accelerate back towards the player while being forced to retract
