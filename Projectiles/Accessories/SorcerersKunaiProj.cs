...
{
	public class SorcerersKunaiProj : ModProjectile
	{
        ...
        public override void AI() {
			...
			Projectile.Center = main.Center - new Vector2(0, 20+offset+(Projectile.width+Projectile.height)/2).RotatedBy(MathHelper.ToRadians(Main.GameUpdateCount+Projectile.ai[0]*120));
			Projectile.rotation = MathHelper.ToRadians(Main.GameUpdateCount+Projectile.ai[0]*120);
			...
			if (!p.sorcerersKunai || !main.active) Projectile.Kill();
        }
