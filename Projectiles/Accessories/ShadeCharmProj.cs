...
{
	public class ShadeCharmProj : ModProjectile
	{
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone) {
			target.AddBuff(BuffID.ShadowFlame, Main.rand.Next(3, 8)*60);
            die = true;
        }
        Projectile main;
		bool die;
        ...
        public override void AI() {
			...
			Projectile.rotation = MathHelper.ToRadians(Main.GameUpdateCount*1.25f+Projectile.ai[0]*120);
			...
			if (!p.shadeCharm || !main.active) Projectile.Kill();
        }
