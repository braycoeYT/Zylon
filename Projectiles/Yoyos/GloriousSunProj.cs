...
{
	public class GloriousSunProj : ModProjectile
	{
        ...
        public override void AI() {
			...
			else if (Timer == 1) { Projectile.alpha = 0; if (Projectile.ai[0] == 1f) SoundEngine.PlaySound(SoundID.Item14, Projectile.Center); Projectile.friendly = true; }
        }
        public override void PostAI() {
			if (Main.rand.NextBool(3) && Projectile.alpha == 0) {
