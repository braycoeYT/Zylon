...
{
	public class PixieArchangelProj : ModProjectile
	{
        ...
        public override void AI() {
			Projectile.tileCollide = Projectile.timeLeft < 60;
		...
		public override bool PreDraw(ref Color lightColor) {
            ...
            Texture2D overlay = (Texture2D)ModContent.Request<Texture2D>("Zylon/Projectiles/Enemies/PixieArchangelProj_Trail");
