...
{
	public class DuskCleaverProj_Mini : ModProjectile
	{
		...
		public override void AI() {
			...
			if (Timer < 20) {
				...
				Vector2 projDir = Vector2.Normalize(targetCenter - Projectile.Center) * 12f;

				if (foundTarget) Projectile.velocity = Projectile.velocity*0.8f + projDir*0.2f;
			}
			else {
