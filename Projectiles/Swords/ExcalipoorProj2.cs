...
{
	public class ExcalipoorProj2 : ModProjectile
	{
        ...
        public override void AI() {
            ...
            for (int i = 0; i < 3; i++) {
				...
				dust.velocity = Projectile.velocity.RotatedByRandom(MathHelper.ToRadians(7f))*-0.5f;
				dust.noGravity = true;
				dust.scale = 1f;
			}
		...
		public override bool PreDraw(ref Color lightColor) {
			...
			Texture2D altTexture = (Texture2D)ModContent.Request<Texture2D>("Zylon/Projectiles/Swords/ExcalipoorProj2_Light");
