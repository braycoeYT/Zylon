...
{
	public class EverlastingBladeProj : ModProjectile
	{
		...
		public override void AI() {
			...
			Timer++;
			if (Timer % 20 == 10 && Main.myPlayer == Projectile.owner) {
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity.RotatedBy(MathHelper.PiOver2), ModContent.ProjectileType<EverlastingBladeProj2>(), (int)(Projectile.damage*0.5f), Projectile.knockBack*0.66f, Projectile.owner);
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity.RotatedBy(-MathHelper.PiOver2), ModContent.ProjectileType<EverlastingBladeProj2>(), (int)(Projectile.damage*0.5f), Projectile.knockBack*0.66f, Projectile.owner);
			}
		...
		public override bool PreDraw(ref Color lightColor) {
            ...
            Color color = Main.DiscoColor*((255f-Projectile.alpha)/255f);
