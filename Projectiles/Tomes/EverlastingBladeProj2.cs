...
{
	public class EverlastingBladeProj2 : ModProjectile
	{
		...
		public override void AI() {
			...
			Timer++;
			if (Timer % 15 == 8 && Main.myPlayer == Projectile.owner) {
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity.RotatedBy(MathHelper.PiOver2), ModContent.ProjectileType<EverlastingBladeProj3>(), (int)(Projectile.damage*0.5f), Projectile.knockBack*0.66f, Projectile.owner);
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity.RotatedBy(-MathHelper.PiOver2), ModContent.ProjectileType<EverlastingBladeProj3>(), (int)(Projectile.damage*0.5f), Projectile.knockBack*0.66f, Projectile.owner);
			}
		...
		public override bool PreDraw(ref Color lightColor) {
            ...
            Color color = new Color(Main.DiscoG, Main.DiscoB, Main.DiscoR)*((255f-Projectile.alpha)/255f);
