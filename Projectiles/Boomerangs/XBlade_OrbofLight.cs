...
{
	public class XBlade_OrbofLight : ModProjectile
	{
        ...
        public override bool PreDraw(ref Color lightColor) {
            ...
            Texture2D overlay = (Texture2D)ModContent.Request<Texture2D>("Zylon/Projectiles/Boomerangs/XBlade_OrbofLight_tracer");
