...
{
	public class EyeLash : ModProjectile
	{
		...
		public override void SetDefaults() {
			...
			Projectile.WhipSettings.RangeMultiplier = 0.65f; //1f
		}
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone) {
			...
			if (Main.myPlayer == Projectile.owner && target.type != NPCID.TargetDummy) Projectile.NewProjectile(Projectile.GetSource_FromThis(), target.Center - new Vector2(0, 200).RotatedByRandom(MathHelper.TwoPi), Vector2.Zero, ModContent.ProjectileType<EyeLashProj>(), Projectile.damage + 2, Projectile.knockBack, Projectile.owner);
		}
