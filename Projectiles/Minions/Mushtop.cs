	...
	public class Mushtop : ModProjectile
	{
		...
		public override void AI() {
			...
			if (Timer % 180 == 0 && foundTarget)
				for (int i = 0; i < 5; i++)
					ProjectileHelpers.NewNetProjectile(new EntitySource_TileBreak((int)Projectile.position.X, (int)Projectile.position.Y), Projectile.Center, new Vector2(0, -5).RotatedByRandom(0.5f), ProjectileType<MushroomSpore>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
