...
{
	public class AdenebBigSun2 : ModProjectile
	{
		...
		public override bool PreDraw(ref Color lightColor) {
			...
			Texture2D ringTexture = (Texture2D)ModContent.Request<Texture2D>("Zylon/Projectiles/Bosses/Adeneb/AdenebBigSun2_rings");
