...
{
	public class AdenebLaserSpeedUp : ModProjectile
	{
		...
		public override void OnHitPlayer(Player target, Player.HurtInfo info) {
            if (info.PvP) target.AddBuff(BuffID.OnFire, Main.rand.Next(2, 6)*60);
        }
		...
		public override bool PreDraw(ref Color lightColor) {
			...
			Texture2D overlayTexture = (Texture2D)ModContent.Request<Texture2D>("Zylon/Projectiles/Bosses/Adeneb/AdenebLaserSpeedUp_overlay");
