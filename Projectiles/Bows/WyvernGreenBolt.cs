...
{
    public class WyvernGreenBolt : ModProjectile
    {
        ...
        public override void PostAI() {
            counter++;
            if (counter % 3 == 0) Dust.NewDust(Projectile.Center, Projectile.width, Projectile.height, ModContent.DustType<Dusts.WyvernGreenDust>());
