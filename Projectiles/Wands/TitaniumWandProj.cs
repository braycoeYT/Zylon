...
{
	public class TitaniumWandProj : ModProjectile
	{
        ...
        public override void AI() {
			...
			if (Projectile.velocity.Length() < 20f) Projectile.velocity *= 1.1f;
        }
		public override void PostAI() {
			if (Main.rand.NextBool()) {
				int dustIndex = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.WhiteTorch);
		...
		public override bool PreDraw(ref Color lightColor) {
            ...
            Texture2D overlay = (Texture2D)ModContent.Request<Texture2D>("Zylon/Projectiles/Wands/TitaniumWandProj_Trail");
