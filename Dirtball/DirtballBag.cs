...
namespace Zylon.Items.Dirtball
{
	public class DirtballBag : ModItem
	{
		...
		public override void OpenBossBag(Player player)
		{
			...
			if (ran == 5) player.QuickSpawnItem(mod.ItemType("DirtyJar"));
			if (ran == 6) player.QuickSpawnItem(mod.ItemType("DirtYoyo"));
			if (ran == 7) player.QuickSpawnItem(mod.ItemType("DirtBow"));
