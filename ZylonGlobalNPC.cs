...
namespace Zylon.NPCs
{
	public class ZylonGlobalNPC : GlobalNPC
	{
		...
		public override void NPCLoot(NPC npc)
		{
			...
			{
				if (Main.player[(int)Player.FindClosest(npc.position, npc.width, npc.height)].ZoneDirtLayerHeight || Main.player[(int)Player.FindClosest(npc.position, npc.width, npc.height)].ZoneRockLayerHeight)
				{
					if (Main.expertMode)
					{
