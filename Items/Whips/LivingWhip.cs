...
namespace Zylon.Items.Whips
{
	public class LivingWhip : ModItem
	{
		...
		public override bool PreDrawInInventory(SpriteBatch spriteBatch, Vector2 position, Rectangle frame, Color drawColor, Color itemColor, Vector2 origin, float scale) {
			...
			if (WorldGen.currentWorldSeed == null) if (WorldGen.currentWorldSeed.ToLower() == "autumn") texture = (Texture2D)ModContent.Request<Texture2D>("Zylon/Items/Whips/LivingWhip_Autumn");
