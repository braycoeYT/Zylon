...
{
	public class VerdureGigaslime : ModNPC
	{
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry) {
			bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
				...
				new FlavorTextBestiaryInfoElement("A powerful slime that protects the forests at all costs.")
			});
        ...
        public override float SpawnChance(NPCSpawnInfo spawnInfo) {
            ...
            return (SpawnCondition.OverworldDaySlime.Chance) * 0.0015f;
        }
		public override void ModifyNPCLoot(NPCLoot npcLoot) {
			...
			npcLoot.Add(new DropBasedOnExpertMode(new CommonDrop(ModContent.ItemType<Items.Yoyos.EarthDay>(), 2), new CommonDrop(ModContent.ItemType<Items.Yoyos.EarthDay>(), 1)));
			npcLoot.Add(new CommonDrop(ItemID.DirtBlock, 1, 20, 30));
			npcLoot.Add(new CommonDrop(ItemID.Acorn, 1, 10, 20));
			npcLoot.Add(new CommonDrop(ItemID.Mushroom, 1, 5, 15));
			npcLoot.Add(new CommonDrop(ItemID.YellowMarigold, 3));
		}
    }
}