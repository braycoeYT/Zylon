...
namespace Zylon.NPCs.Bosses.ADD
{
    ...
    public class ADD_Center : ModNPC
	{
        ...
        public override void SetDefaults() {
			...
			NPC.damage = 26;
			NPC.defense = 10;
			NPC.lifeMax = (int)(1800*ModContent.GetInstance<ZylonConfig>().bossHpMult);
		...
		public override void ModifyNPCLoot(NPCLoot npcLoot) {
			...
			if (Main.expertMode) npcLoot.Add(new CommonDrop(ModContent.ItemType<Items.Bags.DiskiteBag>(), 1));
				...
				npcLoot.Add(new CommonDrop(ModContent.ItemType<Items.Vanity.ADDMask>(), 7)).OnFailedRoll(new CommonDrop(ModContent.ItemType<Items.Vanity.PolandballMask>(), 10));
            }
