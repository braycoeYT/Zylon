...
{
	public class ADD_LaserEye : ModNPC
	{
        ...
        public override void AI() {
			...
			if (NPC.CountNPCS(ModContent.NPCType<ADD_LaserEye2>()) > 0 || main.life < 2) {
				NPC.alpha += 15;
			}
			else NPC.alpha -= 15;
			...
			if (NPC.alpha < 1 && main.life < 2) NPC.active = false;
			...
			NPC.Center = main.Center - new Vector2(0, 16).RotatedBy(MathHelper.ToRadians(degrees)) + main.velocity; //16 for normal
