	...
	public class LittoralGigaslime3 : ModNPC
	{
        ...
        public override void AI() {
			...
			if (Timer % 20 == 0 && ((NPC.life < NPC.lifeMax * 0.875f) || Main.expertMode)) { // + (90*(NPC.life/NPC.lifeMax))) == 0 && (Main.expertMode || NPC.life > NPC.lifeMax / 2))
				Projectile.NewProjectile(NPC.GetSource_FromThis(), NPC.Center, new Vector2(Main.rand.Next(-2, 3) + (Main.rand.Next(-1, 2) * NPC.life/NPC.lifeMax), -4 - Main.rand.Next(0, 3)), ModContent.ProjectileType<Projectiles.Gigaslime.WaterStreamHostile>(), (int)(NPC.damage * 0.2f), 0f, Main.myPlayer);
