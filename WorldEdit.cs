...
namespace Zylon
{
	public class WorldEdit : ModWorld
	{
		 ...
		 public override void NetSend(BinaryWriter writer)
        {
			...
			flags2[0] = downedMechaball;
			flags2[1] = hasAlertSlime;
			flags2[2] = hasAlertEvil;
			flags2[3] = hasConversationDrop;
			flags2[4] = downedXenic;
			flags2[5] = downedEmpress;
		}
		...
		public override void NetReceive(BinaryReader reader)
        {
			...
			downedMechaball = flags2[0];
			hasAlertSlime = flags2[1];
			hasAlertEvil = flags2[2];
			hasConversationDrop = flags2[3];
			downedXenic = flags2[4];
			downedEmpress = flags2[5];
		}
