...
namespace Zylon.Items.Accessories
{
	public class CosmogemGrandscale : ModItem
	{
		public override void SetStaticDefaults()
		{
			...
			Tooltip.SetDefault("Allows the player to dash into the enemy\nDouble tap a direction\nMay confuse nearby enemies after being struck\nImmunity to bleeding, broken armor, burning, chilled,\nconfused, cursed, darkness, feral bite, frostburn, frozen, poisoned,\nsilenced, slow, stoned, and weak");
		}
