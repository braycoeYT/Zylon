...
namespace Zylon
{
	...
	{
		//Future rarities for PML use. Ignore this since most of this doesn't exist yet. Use this as reference for items when we start PML.

		//Tier 12 - All PML banners and trophies. All items that are post PML miniboss, Sabur, and Mineral, and their summons.
